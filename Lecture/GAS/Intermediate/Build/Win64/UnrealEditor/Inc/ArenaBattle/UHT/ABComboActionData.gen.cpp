...
#include "ArenaBattle/Character/ABComboActionData.h"
...
// End Cross Module References
...
#endif
	const UECodeGen_Private::FStrPropertyParams Z_Construct_UClass_UABComboActionData_Statics::NewProp_MontageSectionNamePrefix = { "MontageSectionNamePrefix", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(UABComboActionData, MontageSectionNamePrefix), METADATA_PARAMS(Z_Construct_UClass_UABComboActionData_Statics::NewProp_MontageSectionNamePrefix_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UABComboActionData_Statics::NewProp_MontageSectionNamePrefix_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FBytePropertyParams Z_Construct_UClass_UABComboActionData_Statics::NewProp_MaxComboCount = { "MaxComboCount", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Byte, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(UABComboActionData, MaxComboCount), nullptr, METADATA_PARAMS(Z_Construct_UClass_UABComboActionData_Statics::NewProp_MaxComboCount_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UABComboActionData_Statics::NewProp_MaxComboCount_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_UABComboActionData_Statics::NewProp_FrameRate = { "FrameRate", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(UABComboActionData, FrameRate), METADATA_PARAMS(Z_Construct_UClass_UABComboActionData_Statics::NewProp_FrameRate_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UABComboActionData_Statics::NewProp_FrameRate_MetaData)) };
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UABComboActionData_Statics::NewProp_EffectiveFrameCount = { "EffectiveFrameCount", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(UABComboActionData, EffectiveFrameCount), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UClass_UABComboActionData_Statics::NewProp_EffectiveFrameCount_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UABComboActionData_Statics::NewProp_EffectiveFrameCount_MetaData)) };
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UABComboActionData_Statics::ClassParams = {
		...
		0,
		0x001000A0u,
		METADATA_PARAMS(Z_Construct_UClass_UABComboActionData_Statics::Class_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UClass_UABComboActionData_Statics::Class_MetaDataParams))
	};
	...
	struct Z_CompiledInDeferFile_FID_Game_Engine_UE5_Inflearn_GAS_GAS_Study_Lecture_GAS_Source_ArenaBattle_Character_ABComboActionData_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Game_Engine_UE5_Inflearn_GAS_GAS_Study_Lecture_GAS_Source_ArenaBattle_Character_ABComboActionData_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UABComboActionData, UABComboActionData::StaticClass, TEXT("UABComboActionData"), &Z_Registration_Info_UClass_UABComboActionData, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UABComboActionData), 2390294232U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Game_Engine_UE5_Inflearn_GAS_GAS_Study_Lecture_GAS_Source_ArenaBattle_Character_ABComboActionData_h_377557041(TEXT("/Script/ArenaBattle"),
		Z_CompiledInDeferFile_FID_Game_Engine_UE5_Inflearn_GAS_GAS_Study_Lecture_GAS_Source_ArenaBattle_Character_ABComboActionData_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Game_Engine_UE5_Inflearn_GAS_GAS_Study_Lecture_GAS_Source_ArenaBattle_Character_ABComboActionData_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
